...
(library Library_1
	...
	(patternDef "17791063215" (originalName "17791063215")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.01 -6) (pt 19.79 -6) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 19.79 -6) (pt 19.79 3.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 19.79 3.2) (pt -2.01 3.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.01 3.2) (pt -2.01 -6) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "17791063215" (originalName "17791063215") (compHeader (numPins 7) (numParts 1) (refDesPrefix PS)
		...
		(compPin "5" (pinName "NC") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "FB") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.mouser.de/datasheet/2/445/17791063215-1715724.pdf")
		(attr "<Component Height>" "11.6")
		(attr "<STEP Filename>" "17791063215.stp")
